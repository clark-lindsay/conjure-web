...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    // (9:2) <div     class={sourceOptionsMenu ? 'invisible' : ''}     slot="left"     data-testid="spellOptionsMenuDiv">
    function create_left_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", div_class_value = /*sourceOptionsMenu*/ ctx[1] ? "invisible" : "");
    			attr_dev(div, "slot", "left");
    			attr_dev(div, "data-testid", "spellOptionsMenuDiv");
    			add_location(div, file$2, 8, 2, 286);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty & /*sourceOptionsMenu*/ 2 && div_class_value !== (div_class_value = /*sourceOptionsMenu*/ ctx[1] ? "invisible" : "")) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(9:2) <div     class={sourceOptionsMenu ? 'invisible' : ''}     slot=\\\"left\\\"     data-testid=\\\"spellOptionsMenuDiv\\\">",
    		ctx
    	});
    ...
    // (15:2) <div     class={spellOptionsMenu ? 'invisible' : ''}     slot="right"     data-testid="sourceOptionsMenuDiv">
    function create_right_slot(ctx) {
    	...
    	function hamburgerbutton_open_binding_1(value) {
    		/*hamburgerbutton_open_binding_1*/ ctx[4].call(null, value);
    	}

    	let hamburgerbutton_props = { left: false };

    	if (/*sourceOptionsMenu*/ ctx[1] !== void 0) {
    		hamburgerbutton_props.open = /*sourceOptionsMenu*/ ctx[1];
    	}
    	...
    	binding_callbacks.push(() => bind(hamburgerbutton, "open", hamburgerbutton_open_binding_1));
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "data-testid", "sourceOptionsMenuDiv");
    			add_location(div, file$2, 14, 2, 459);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(hamburgerbutton, div, null);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_open && dirty & /*sourceOptionsMenu*/ 2) {
    				updating_open = true;
    				hamburgerbutton_changes.open = /*sourceOptionsMenu*/ ctx[1];
    				add_flush_callback(() => updating_open = false);
    			}

    			hamburgerbutton.$set(hamburgerbutton_changes);

    			if (!current || dirty & /*spellOptionsMenu*/ 1 && div_class_value !== (div_class_value = /*spellOptionsMenu*/ ctx[0] ? "invisible" : "")) {
    				attr_dev(div, "class", div_class_value);
    			}
    		},
    		i: function intro(local) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(15:2) <div     class={spellOptionsMenu ? 'invisible' : ''}     slot=\\\"right\\\"     data-testid=\\\"sourceOptionsMenuDiv\\\">",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, spellOptionsMenu, sourceOptionsMenu*/ 35) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [
    		...
    		sourceOptionsMenu,
    		heading,
    		hamburgerbutton_open_binding,
    		hamburgerbutton_open_binding_1
    	];
    }
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$9, 134, 10, 4547);
    			add_location(div1, file$9, 125, 8, 4184);
    			attr_dev(div2, "class", "flex w-1/2 mr-2");
    			add_location(div2, file$9, 123, 6, 4116);
    			attr_dev(div3, "class", "flex flex-wrap w-1/2 content-start overflow-y-auto max-h-screen");
    			add_location(div3, file$9, 142, 6, 4796);
    			attr_dev(div4, "class", "flex overflow-hidden h-full");
    			add_location(div4, file$9, 122, 4, 4068);
    		},
    		m: function mount(target, anchor) {
    			mount_component(navbar, target, anchor);
    ...
    function create_if_block$3(ctx) {
    	...
    	function mobilenavbar_sourceOptionsMenu_binding(value) {
    		/*mobilenavbar_sourceOptionsMenu_binding*/ ctx[9].call(null, value);
    	}
    	...
    	if (/*rightSidebarIsOpen*/ ctx[2] !== void 0) {
    		mobilenavbar_props.sourceOptionsMenu = /*rightSidebarIsOpen*/ ctx[2];
    	}
    	...
    	binding_callbacks.push(() => bind(mobilenavbar, "sourceOptionsMenu", mobilenavbar_sourceOptionsMenu_binding));
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_sourceOptionsMenu && dirty & /*rightSidebarIsOpen*/ 4) {
    				updating_sourceOptionsMenu = true;
    				mobilenavbar_changes.sourceOptionsMenu = /*rightSidebarIsOpen*/ ctx[2];
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$9, 128, 12, 4272);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_each_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file$9, 156, 18, 5350);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$9, 154, 14, 5274);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block_2$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$9, 145, 10, 4938);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
