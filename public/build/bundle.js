    ...
    ***************************************************************************** */
    ...
    function create_if_block$3(ctx) {
    	...
    	function navbar_spellOptionsMenu_binding(value) {
    		/*navbar_spellOptionsMenu_binding*/ ctx[8].call(null, value);
    	}

    	function navbar_sourceOptionsMenu_binding(value) {
    		/*navbar_sourceOptionsMenu_binding*/ ctx[9].call(null, value);
    	}
    	...
    	if (/*leftSidebarIsOpen*/ ctx[1] !== void 0) {
    		navbar_props.spellOptionsMenu = /*leftSidebarIsOpen*/ ctx[1];
    	}

    	if (/*rightSidebarIsOpen*/ ctx[2] !== void 0) {
    		navbar_props.sourceOptionsMenu = /*rightSidebarIsOpen*/ ctx[2];
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_spellOptionsMenu && dirty & /*leftSidebarIsOpen*/ 2) {
    				...
    				navbar_changes.spellOptionsMenu = /*leftSidebarIsOpen*/ ctx[1];
    			...
    			if (!updating_sourceOptionsMenu && dirty & /*rightSidebarIsOpen*/ 4) {
    				...
    				navbar_changes.sourceOptionsMenu = /*rightSidebarIsOpen*/ ctx[2];
    ...
    // (81:4) <Sidebar bind:open={leftSidebarIsOpen}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(81:4) <Sidebar bind:open={leftSidebarIsOpen}>",
    		ctx
    	});
    ...
    // (84:4) <Sidebar bind:open={rightSidebarIsOpen} left={false}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(84:4) <Sidebar bind:open={rightSidebarIsOpen} left={false}>",
    		ctx
    	});
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			create_component(alert.$$.fragment);
    			add_location(div, file$8, 88, 6, 2908);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(alert, div, null);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(88:4) {#if disableCastButton}",
    		ctx
    	});
    ...
    // (112:14) {#each result.creatures as creature}
    function create_each_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file$8, 112, 16, 3829);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(112:14) {#each result.creatures as creature}",
    		ctx
    	});
    ...
    // (107:10) <ResultBox             heading={result.spellName}             challengeRating={result.challengeRating}             terrains={result.terrains}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$8, 110, 12, 3757);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, ul, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(107:10) <ResultBox             heading={result.spellName}             challengeRating={result.challengeRating}             terrains={result.terrains}>",
    		ctx
    	});
    ...
    // (102:6) {#each results as result (result.id)}
    function create_each_block$2(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			create_component(resultbox.$$.fragment);
    			t = space();
    			add_location(div, file$8, 102, 8, 3461);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(102:6) {#each results as result (result.id)}",
    		ctx
    	});
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link, file$8, 66, 2, 2236);
    			...
    			add_location(div, file$8, 71, 0, 2350);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class ResponsiveApp extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { containerWidth: 0 });
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$9, 5, 0, 178);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
