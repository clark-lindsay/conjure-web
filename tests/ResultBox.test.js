...
describe("the ResultBox component", () => {
  ...
  it("accepts a heading, that will be rendered as a semantic heading, with a default of Result", async () => {
  ...
  it("accepts a challenge rating and a terrain list, but only displays something if they are given", async () => {
